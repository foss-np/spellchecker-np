...
static int HunSpell_init(HunSpell * self, PyObject *args, PyObject *kwds) {
  char *dpath;
  char *apath;
...
static void HunSpell_dealloc(HunSpell * self) {
  Hunspell_destroy(self->handle);
  self->ob_type->tp_free((PyObject *)self);
}

static PyObject * HunSpell_get_dic_encoding(HunSpell * self, PyObject *args) {
  return Py_BuildValue("s", Hunspell_get_dic_encoding(self->handle));
}

static PyObject * HunSpell_spell(HunSpell * self, PyObject *args) {
  char *word;
  int retvalue;
...
HunSpell_add_with_affix(HunSpell * self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "ss", &word, &example)) return NULL;
...
static PyMethodDef HunSpell_methods[] = {
  {"get_dic_encoding", (PyCFunction) HunSpell_get_dic_encoding, METH_NOARGS, "Gets encoding of loaded dictionary."},
  {"spell", (PyCFunction) HunSpell_spell, METH_VARARGS,  "Checks the spelling of the given word."},
  {"suggest", (PyCFunction) HunSpell_suggest, METH_VARARGS, "Provide suggestions for the given word."},
  {"analyze", (PyCFunction) HunSpell_analyze, METH_VARARGS, "Provide morphological analysis for the given word."},
  {"stem", (PyCFunction) HunSpell_stem, METH_VARARGS, "Stemmer method."},
  {"generate", (PyCFunction) HunSpell_generate, METH_VARARGS, "Provide morphological generation for the given word."},
  {"add", (PyCFunction) HunSpell_add, METH_VARARGS, "Adds the given word into the runtime dictionary"},
  {"add_with_affix", (PyCFunction) HunSpell_add_with_affix, METH_VARARGS, "Adds the given word with affix flags of the example (a dictionary word) into the runtime dictionary"},
  {"remove", (PyCFunction) HunSpell_remove, METH_VARARGS, "Removes the given word from the runtime dictionary"},
  {NULL}
};
...
inithunspell(void) {
  ...
  if (PyType_Ready(&HunSpellType) < 0) return;
